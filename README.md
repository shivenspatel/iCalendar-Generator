...
The web-scraping element that pulls the data from the university website and cleans it into a format that allows it to be processed by the backend is currently under development.
